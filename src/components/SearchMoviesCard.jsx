...
export default function SearchMoviesCard({searchMovie, searchResults}) {
  ...
  return (
    <div style={{backgroundColor: "rgba(0, 0, 0, 0.9)", backgroundSize: 'cover', backgroundPosition: 'center', width:"100vw", }}>
      <h1 style={{margin:"0px", padding:"20px", marginBottom:"1em",  fontSize: '50px', textAlign: "center", color: "#bca297", fontFamily: "Luckiest Guy", borderBottom: "solid", borderTop: "solid"}}>{searchMovie}</h1>
